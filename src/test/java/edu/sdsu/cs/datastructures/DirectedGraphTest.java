...
public class DirectedGraphTest {
    ...
    public void defaultConstructor_initCorrectly() {
        ...
        try {
            for (String label : sut.vertices())
                fail(String.format("Structure should be empty. Found: %s",
                        label));
    ...
    public void remove_middleLayer_validSize() {
        DirectedGraph<Integer> sut = buildSimpleThreeLayer(new
                DirectedGraph<>());
    ...
    private DirectedGraph<Integer> buildSimpleThreeLayer(DirectedGraph<Integer>
                                                                 sut) {
        // initial layer
        sut.add(NODE_INITIAL);
        // middle layer
    ...
    public void clear_sequentialGraph_empty() {
        //DirectedGraph<Integer> sut = straightLineGraph(new DirectedGraph<>());
        DirectedGraph<Integer> sut =
                straightLineGraph(new DirectedGraph<Integer>());
